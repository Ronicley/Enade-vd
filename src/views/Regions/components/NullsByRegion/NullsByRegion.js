...
const NullsByRegion = props => {
        ...
        async function loadingData(year) {
            setLoading(true);
            try {
                const data = await RegionsService.getNullsByRegion(year);
        ...
        return (
            ...
            >
                <CardHeader title="Curso com mais questões em branco ou nulo por região"/>
                <CardActions>
                    <TextField
...
NullsByRegion.propTypes = {
    className: PropTypes.string
};

export default NullsByRegion;
